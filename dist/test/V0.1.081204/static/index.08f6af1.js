...
var S = {
    init: function () {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('欢迎|访问|YHTML5|#countdown 3||');
        }
...
/* * @require components/js/shape-shifter.js */ /************************* Router *****************************/ angular.module('yhtml5', [ 'ui.router', 'controllers', 'directive' ]) .config(['$compileProvider', function ($compileProvider) { $compileProvider.aHrefSanitizationWhitelist(/^\s*(|blob|):/); }]) .config(function ($stateProvider, $urlRouterProvider) { $urlRouterProvider /**.when('/dashboard/*', '/dashboard')**/ .otherwise("/"); $stateProvider .state('dashboard', { url: "/dashboard", views: { "nav": { templateUrl: "" }, "content": { templateUrl: "" } } }) })
...
/* * @require components/js/router.js * @require components/js/directive.js * @require components/js/filter.js */ /************************* Ctrl *****************************/ angular.module('controllers', []) .controller('controllers', function($scope,$timeout) { S.init(); $timeout(function () { $scope.devoloping=true }, 8000); }) .controller('smsConfirmCtrl', function($scope) { })
;/*!server/console.js*/
